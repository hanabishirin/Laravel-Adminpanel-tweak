...
@section ('title', trans('labels.backend.school.management') . ' | ' . trans('labels.backend.school.create'))
...
@section('content')
    <div class="box box-info">
        ...
        {{ Form::open(['route' => 'admin.schools.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'main_form','files' => true]) }}

        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.school.create') }}</h3>
        ...
        <div class="box-body">
                ...
                <div class="col-lg-1">
                    <div class="control-group">
                        <label class="control control--checkbox">
                            {{ Form::checkbox('is_public', '1', false) }}
            ...
            <div class="form-group">
                <div class="col-lg-10">
                    <input type="file" name="school_img_url" />
                </div><!--col-lg-10-->
            </div><!--form control-->
