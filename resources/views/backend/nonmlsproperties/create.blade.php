...
@section('content')
    <div class="box box-info">
        {{ Form::open(['route' => 'admin.nonmlsproperties.store', 'class' => 'form-horizontal dropzone no_dropzone', 'role' => 'form', 'method' => 'post', 'id' => 'main_form']) }}
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('area',$area, "", ['class' => 'form-control select2 box-size']) }}
                </div><!--col-lg-3-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('city',$cities, "", ['class' => 'form-control select2 box-size']) }}
                </div><!--col-lg-3-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('p_type',array( 'attach' => trans('labels.backend.nonmls.select.p_type.attach'), 'detach' => trans('labels.backend.nonmls.select.p_type.detach'), 'land' => trans('labels.backend.nonmls.select.p_type.land')), "", ['class' => 'form-control select2 box-size']) }}
                </div><!--col-lg-3-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('community',$communities, "", ['class' => 'form-control select2 box-size']) }}
                </div><!--col-lg-3-->
            </div><!--form control-->
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::select('dwelling',array( 'attach' => trans('labels.backend.nonmls.select.p_type.attach'), 'detach' => trans('labels.backend.nonmls.select.p_type.detach'), 'land' => trans('labels.backend.nonmls.select.p_type.land')), "", ['class' => 'form-control select2 box-size']) }}
                </div><!--col-lg-3-->
            </div><!--form control-->
        ...
        <div class="box-body">
            <div class="edit-form-btn">
                ...
                <div class="error-message"><span style="color: red;">Please attach the image!</span></div>
            </div>
        </div>
...
@section('after-scripts')
    ...
    <script type="text/javascript">
        ...
        Dropzone.options.mainForm = {
            ...
            paramName: 'images', // this is optional Like this one will get accessed in php by writing $_FILE['pic'] // if you dont specify it then bydefault it taked 'file' as paramName eg: $_FILE['file']
            ...
            accept: function(file, done) {
                ...
                if ($('#dropzonePreview').height() > $('#dropzoneClick').height())
                {
                    $('#dropzoneClick').height($('#dropzonePreview').height());
                }

                $('#dropzoneClick p').hide();
                $('.dz-progress').hide();
            ...
            init: function()
            {
                ...
                this.on("removedfile", function(file){
                    if ($('#dropzonePreview').height() < $('#dropzoneClick').height())
                    {
                        $('#dropzoneClick').height("150px");
                        $('#dropzoneClick p').show();
                    }
                });
